         ...
         { this.state.displayFomrs ? 
          ...
          <i className='material-icons prefix'>group_add</i>
               <select className = 'icons' value={this.state.nbP}  onChange={this.handleNbPChange} required >
                  <option value = '-1' disabled  data-icon ={errorIMG} >Select </option>
                  <option value = '2' data-icon ={twoIMG} > two guests </option>
                  <option value = '3' data-icon ={threeIMG} > three guests</option>
                  <option value = '4' data-icon ={fourIMG} > four guests </option>
                  <option value = '5' data-icon ={fiveIMG} > five guests</option>
               </select>
